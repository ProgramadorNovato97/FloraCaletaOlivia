        ...
        private suspend fun precargarDatos(plantaDao: PlantaDao) {
            ...
            val plantas = listOf(
                ...
                Planta(
                    ...
                    descripcion = "Austrocactus Bertinii (Parada 3). Es una planta columnar con costillas rectas y espinas radiales y o centrales algo arqueadas. Las flores son acampanadas rosado – amarillentas y de un tamaño grande, dispuestas próximas al ápice en número de tres – cinco o más, recubiertas externamente por mechones lanosos y cerdas oscuras. El estigma de la flor está formado por 16 lóbulos de color púrpura. Fácilmente observable debajo de otros arbustos. La época de floración es en el comienzo del verano. Sus flores atraen una gran diversidad e insectos polinizadores. Las semillas germinan con mucha facilidad (Parada 3).",
                ...
                Planta(
                    id = "fabiana",
                    nombre = "Fabiana",
                    descripcion = "Fabiana Nana (Parada 10). Es un arbusto de apariencia áfila, muy ramoso que llega a 1.5 m de altura, pero puede encontrarse como cojín al ras del suelo. Las ramas jóvenes presentan pequeñas hojitas que crecen paralelas a las ramas. Sin embargo, presenta un aspecto áfilo (sin hojas), debido a su tamaño milimétrico. Las flores son tubuladas y de color blanco-amarillento o amarillo-verdoso. Se disponen en gran cantidad en los extremos de las ramitas jóvenes (Parada 10).",
                ...
                Planta(
                    id = "brachiclados",
                    nombre = "Brachiclados",
                    descripcion = "(Parada 10. Arbusto bajo y resistente. Se caracteriza por un crecimiento ramificado, con hojas pequeñas y angostas que se enrollan en los bordes lo que les ayuda a conservar agua. Posee flores, parecidas a margaritas, son de color amarillo y aparecen de manera solitaria en las puntas de las ramas. Están adaptadas a condiciones extremas de viento, sequías y suelos pobres. Suelen ser muy bajas, con el aspecto de una piedra, desarrollándose bien cerca del suelo. Cumplen un papel importante en el ecosistema: ayudan a evitar la erosión, brindan refugio a insectos polinizadores y mantienen la vegetación en ambientes áridos (Parada 10).",
